...
Use this to systematically find the best parameters for a specific pool without manual tuning.`,
...

  {
    ...
    function: {
      ...
      description: `Get the structured decision log — every deploy, close, and skip outcome with the recorded reasoning.
...
This is the preferred tool for answering "why" — it returns recorded reasoning without triggering any live trading actions.`,
      parameters: {
        type: "object",
        properties: {
